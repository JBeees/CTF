...
## Hints
- https://artifacts.picoctf.net/c/507/asciiftw
...
```
Each instruction stores a single ASCII byte into the buffer. Converting those hex immediate values to characters in order reconstructs the flag.
